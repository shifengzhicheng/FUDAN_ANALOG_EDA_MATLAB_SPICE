%% 文件作者: 林与正
%% 初始值方法一 DC模型解
function [InitRes, InitDeviceValue, CVi, CIi, LVi, LIi] = TransInitial_byDC(LinerNet_Trans, MOSINFO_Trans, DIODEINFO_Trans, BJTINFO_Trans, ...
...
if isKey(MOSINFO_DC, 'MOSLine') && isKey(MOSINFO_Trans, 'MOSLine') && isKey(MOSINFO_Trans, 'L')
...
if isKey(BJTINFO_DC, 'BJTLine') && isKey(BJTINFO_Trans, 'BJTLine') && isKey(BJTINFO_Trans, 'L')
