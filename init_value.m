...
%     end
    ...
    for i = 1:numel(DeviceInfo)
        ...
        for j = numel(DeviceInfo{i}.nodes):1
            %% 找源极接Gnd的NMOS
            ...
            if Type >= 1 && isequal(DeviceInfo{i}.nodes{3}, Gnd_node)
                ...
                elseif Type == 2
                    if NodeInfo{ DeviceInfo{i}.nodes{1}+1 }.value == -1
                        NodeInfo{ DeviceInfo{i}.nodes{1}+1 }.value = 0.1;
                    end
                    if NodeInfo{ DeviceInfo{i}.nodes{2}+1 }.value == -1
            ...
            elseif Type <= -1 && isequal(DeviceInfo{i}.nodes{3}, Vdd_node)
                ...
                elseif Type == -2
                    if NodeInfo{ DeviceInfo{i}.nodes{1}+1 }.value == -1
                        NodeInfo{ DeviceInfo{i}.nodes{1}+1 }.value = Vdd - 0.1;
                    end
                    if NodeInfo{ DeviceInfo{i}.nodes{2}+1 }.value == -1
                        NodeInfo{ DeviceInfo{i}.nodes{2}+1 }.value = Vdd - 0.6667;
                    end
                end
                % S
            ...
            elseif abs(Type) == 2
                ...
                if NodeInfo{ DeviceInfo{i}.nodes{3}+1 }.value ~= -1
                    ...
                    if NodeInfo{ DeviceInfo{i}.nodes{2}+1 }.value == -1
                        NodeInfo{ DeviceInfo{i}.nodes{2}+1 }.value = NodeInfo{ DeviceInfo{i}.nodes{3}+1 }.value + 0.1 * Type/2;
                    end
                ...
                elseif NodeInfo{ DeviceInfo{i}.nodes{2}+1 }.value ~= -1
                    ...
                    % E一定未赋过初值
                    NodeInfo{ DeviceInfo{i}.nodes{3}+1 }.value = NodeInfo{ DeviceInfo{i}.nodes{2}+1 }.value - 0.1 * Type/2;
                    % C一定未赋过初值
                    NodeInfo{ DeviceInfo{i}.nodes{1}+1 }.value = NodeInfo{ DeviceInfo{i}.nodes{3}+1 }.value + 0.6667 * Type/2;
                end
                break;
            ...
            elseif isequal(DeviceInfo{i}.type, 'source') && isequal(DeviceInfo{i}.name(1), 'V')
                if isequal(DeviceInfo{i}.nodes{2}, Gnd_node)
                    NodeInfo{ DeviceInfo{i}.nodes{1}+1 }.value = NodeInfo{ DeviceInfo{i}.nodes{2}+1 }.value + DeviceInfo{i}.value;
                elseif NodeInfo{ DeviceInfo{i}.nodes{1}+1 }.value ~= -1 && NodeInfo{ DeviceInfo{i}.nodes{2}+1 }.value == -1
